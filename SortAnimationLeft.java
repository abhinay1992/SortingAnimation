...
public class SortAnimationLeft extends JPanel {

    private final Border bd = BorderFactory.createLineBorder(Color.BLACK);
    ...
    public SortAnimationPanelLeft sapl;
    public int threadSpeed=100;
    public SortAnimationLeft()
    {
        setSize(360,300);
        setLayout(new BorderLayout());
        sapl = new SortAnimationPanelLeft();
        ...
        add(sapl,BorderLayout.CENTER);
        add(sortAlgorithmList,BorderLayout.SOUTH);
    }
    
    public class SortAnimationPanelLeft extends JPanel implements Runnable
    {
        public SortAnimationPanelLeft()
        {
            setBorder(bd);
